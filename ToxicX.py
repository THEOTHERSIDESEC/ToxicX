...
os.system("toilet -f big ' TOXIC X' -F gay | lolcat  ")
print
print ("\033[49m                   Welcome To ToxicX                    \033[0m")
...
def help():
  print
  print ("\033[44m Developer : Versacefer \033[0m")
  print ("\033[44m Program : ToxicX\033[0m")
  ...
  if dr == "show options":
    ...
    ###########
		...
		if dea == "run":
			...
			print
			main()
  elif dr == "ToxicX update":
    print ""+G+"~ "+B+"UPDATING..."
    time.sleep(2)
    print ""+G+"Cloning repo..."
    time.sleep(6)
    os.system("cd ..;rm -rf ToxicX;git clone https://github.com/THEOTHERSIDESEC/ToxicX;cd ToxicX;python2 ToxicX.py")
    main()
  elif dr == "10":
    time.sleep(1)
    print ""+R+"exiting..."
